...
import (
	...
	"github.com/akhidrb/oapi-codegen/pkg/types"
)
...
func StyleParamWithLocation(
	style string, explode bool, paramName string, paramLocation ParamLocation, value interface{},
) (string, error) {
...
func styleSlice(
	style string, explode bool, paramName string, paramLocation ParamLocation, values []interface{},
) (string, error) {
	if style == "deepObject" {
		if !explode {
...
func processFieldDict(
	style string, explode bool, paramName string, paramLocation ParamLocation, fieldDict map[string]string,
) (string, error) {
	var parts []string
